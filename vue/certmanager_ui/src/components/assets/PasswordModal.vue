    ...
    <dialog id="setPassword" class="modal">
      ...
      <div class="holder">
        ...
        <div style="text-align: center; margin-left: auto; margin-right: auto;">
          <input @keyup.enter="do_login" v-model="this.currentPass" type="password" id="passwordold" name="password"
            placeholder="CURRENT USER PASSWORD" required><br>

          <input style="margin-top: 2px;" v-on:input="checkStatus" v-model="this.newPass1" type="password"
            id="password1" name="password" placeholder="NEW PASSWORD" required><br>

          <input v-on:input="checkStatus" v-model="this.newPass2" type="password" id="password" name="password2"
            placeholder="VERIFY NEW PASSWORD" required><br>
...
<script>
  ...
  export default {
    ...
    methods: {
      showModal: function (requestedFor) {
      ...
      changePassword: async function () {
        ...
        var foruser = undefined
        if (this.requestedFor != undefined) {
          foruser = this.requestedFor
        } else {
