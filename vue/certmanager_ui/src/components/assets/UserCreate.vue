<template>
  <div>
    <dialog id="UserCreate" class="modal">
      ...
      <div class="holder">
        ...
        <div style="text-align: left; margin-right: auto; padding: 10px;">
                  <input v-model="this.username" type="text" id="username" name="username" placeholder="Username"
          style=" width: 300px; display: inline-block; vertical-align: middle;" required>
          ...
          <input v-model="this.password" type="text" id="genpass" name="genpass" placeholder="Generated Password"
        ...
        <div style="text-align: center; margin-left: auto; margin-right: auto;">
          ...
          <button class="glass-button" @click="generateKey()">Create User</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      showModal: function () {
        console.log("showingUserCreate")
        var e = document.getElementById('UserCreate')
        e.showModal()
      },

      hideModal: function () {
        console.log("hidingUserCreate")
        var e = document.getElementById('UserCreate')
        e.close()
      },
      ...
      generateKey: async function () {
        ...
        var response = await this.$refs.ApiConnect.send_post(`/user/create/`, payload, {}, false)
